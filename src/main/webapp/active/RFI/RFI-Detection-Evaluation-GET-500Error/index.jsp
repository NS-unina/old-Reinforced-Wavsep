...
<center><font size="5">RFI Test Cases - HTTP 500 Responses with Erroneous Text:</font></center><br><br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an unrestricted HTTP URL, default full path input, without path requirements, and in the scope of a page with erroneous 500 responses.<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an unrestricted HTTP URL, default invalid input, without path requirements, and in the scope of a page with erroneous 500 responses.<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an unrestricted HTTP URL, default empty input, without path requirements, and in the scope of a page with erroneous 500 responses.<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an unrestricted HTTP URL, default full path input, without application full path support (no-path requirement), and in the scope of a page with erroneous 500 responses.<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an unrestricted HTTP URL, default invalid input, without application full path support (no-path requirement), and in the scope of a page with erroneous 500 responses.<br>
  Clarification: The test case concatenates a default full path prefix to the input received - preventing the direct injection of full application path (without traversal characters)<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an unrestricted HTTP URL, default empty input, without application full path support (no-path requirement), and in the scope of a page with erroneous 500 responses.<br>
  Clarification: The test case concatenates a default full path prefix to the input received - preventing the direct injection of full application path (without traversal characters)<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an HTTP URL with flawed http text validation, default full path input, without path requirements, and in the scope of a page with erroneous 500 responses.<br>
  ...
  RFI attack abusing the URL Class: injection into a filename context, using an HTTP URL with flawed http text removal, default full path input, without path requirements, and in the scope of a page with erroneous 500 responses.<br>
