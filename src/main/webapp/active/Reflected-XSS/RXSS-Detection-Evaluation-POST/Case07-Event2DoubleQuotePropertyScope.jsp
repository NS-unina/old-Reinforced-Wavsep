...
<title>Case 7 - RXSS via DHTML event injection into the scope of an HTML property (Double Quote Delimiter)</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case07-Event2DoubleQuotePropertyScope.jsp" method="POST">
