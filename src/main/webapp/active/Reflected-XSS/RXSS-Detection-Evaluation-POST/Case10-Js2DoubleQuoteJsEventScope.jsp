...
<title>Case 10 - RXSS via Javascript injection into the scope of an HTML/Javascript Event (Double Quote Delimiter)</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case10-Js2DoubleQuoteJsEventScope.jsp" method="POST">
