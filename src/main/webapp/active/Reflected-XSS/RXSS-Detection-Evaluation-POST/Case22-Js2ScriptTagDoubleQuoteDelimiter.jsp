...
<title>Case 22 - RXSS via Javascript injection into the scope of a script tag (Javascript, Double Quote String Delimiter)</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case22-Js2ScriptTagDoubleQuoteDelimiter.jsp" method="POST">
