...
<B><a href="Case01-InjectionInView-Numeric-Blind-200ValidResponseWithDefaultOnException.jsp">Case01-InjectionInView-Numeric-Blind-200ValidResponseWithDefaultOnException.jsp</a></B><br>
  ...
  MySQL: 1 and 1 in (select BENCHMARK(20000000,MD5(CHAR(97))) ) --     <br>
  <br>
  
  
  <B><a href="Case02-InjectionInView-String-Blind-200ValidResponseWithDefaultOnException.jsp">Case02-InjectionInView-String-Blind-200ValidResponseWithDefaultOnException.jsp</a></B><br>
  ...
  <U>Examples of Time Based Detection Inputs:</U><br>
  MySQL: user1' and 1 in (select BENCHMARK(20000000,MD5(CHAR(97))) ) --     <br>
  <br>
  
  <B><a href="Case03-InjectionInView-Date-Blind-200ValidResponseWithDefaultOnException.jsp">Case03-InjectionInView-Date-Blind-200ValidResponseWithDefaultOnException.jsp</a></B><br>
  ...
  <U>Examples of Time Based Detection Inputs:</U><br>
  MySQL: 2010-01-01' and 1 in (select BENCHMARK(20000000,MD5(CHAR(97))) ) --     <br>
  <br>
  
  <B><a href="Case04-InjectionInUpdate-Numeric-TimeDelayExploit-200Identical.jsp">Case04-InjectionInUpdate-Numeric-TimeDelayExploit-200Identical.jsp</a></B><br>
  ...
  MySQL Detection: 1 and exists ([time delay function])[comment][space]<br>
  <U>Examples of Time Based Detection Inputs:</U><br>
  MySQL: 895 and 1 in (select BENCHMARK(20000000,MD5(CHAR(97))) ) --     <br>
  <br>
  
  <B><a href="Case05-InjectionInUpdate-String-TimeDelayExploit-200Identical.jsp">Case05-InjectionInUpdate-String-TimeDelayExploit-200Identical.jsp</a></B><br>
  ...
  MySQL Detection: value' and exists ([time delay function])[comment][space]<br>
  <U>Examples of Time Based Detection Inputs:</U><br>
  MySQL: empty' and 1 in (select BENCHMARK(20000000,MD5(CHAR(97))) ) --     <br>
  <br>
  
  <B><a href="Case06-InjectionInUpdate-Date-TimeDelayExploit-200Identical.jsp">Case06-InjectionInUpdate-Date-TimeDelayExploit-200Identical.jsp</a></B><br>
  ...
  MySQL Detection: [date value]' and exists ([time delay function])[comment][space]<br>
  <U>Examples of Time Based Detection Inputs:</U><br>
  MySQL: 2010-02-02' and 1 in (select BENCHMARK(20000000,MD5(CHAR(97))) ) --     <br>
  <br>
  
  <B><a href="Case07-InjectionInUpdate-NumericWithoutQuotes-TimeDelayExploit-200Identical.jsp">Case07-InjectionInUpdate-NumericWithoutQuotes-TimeDelayExploit-200Identical.jsp</a></B><br>
  ...
  <B><a href="Case08-InjectionInUpdate-DateWithoutQuotes-TimeDelayExploit-200Identical.jsp">Case08-InjectionInUpdate-DateWithoutQuotes-TimeDelayExploit-200Identical.jsp</a></B><br>
